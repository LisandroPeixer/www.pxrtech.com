...
<html>
	<head>
		...
		<script>
			function editar(id, txt_data, txt_abertura, txt_intervalo, txt_fechamento, txt_nome, txt_email) {
			...
			<div class="row">
				<div class="col-md-2 menu">
					<ul class="list-group">
						...
						<li class="list-group-item active"><a href="todas_tarefas.php">Todos eventos</a></li>
					</ul>
				</div>
						...
						<div class="row">
							<div class="col">
								...
								<? foreach($tarefas as $indice => $tarefa) { ?>
									<div class="row mb-3 d-flex align-items-center tarefa"><!--impressão de todas as tarefa-->
